...
* 基本概念
  ...
  - IP协议主要解决寻址和路由问题
  - ipv4，地址是四个用“.”分隔的数字，总数有 2^32个，大约42亿个可以分配的地址
  - ipv6，地址是八个用“:”分隔的数字，总数有 2^128个
...
* 学习分析的工具
  ...
  - OpenResty：基于 Nginx 的一个强化包，相当于nginx的超集
...
* request header
  ...
  - Cache-Control 与 Expires之强制缓存的值为 public, max-age=xxx 表示在xxx秒内再次访问该资源，均使用本地的缓存，不再向服务器发起请求
  - cookie
...
* ssl/tsl 发展历程:
  - ssl3.0后叫 tsl 目前应用的最广泛的 TLS 是 1.2，
...
* https协议的工作原理
  - 客户使用 https url访问服务器，则要求web服务器建立ssl链接。
